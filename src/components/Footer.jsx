...
const Footer = () => {
  return (
    <div className='w-full h-screen bg-black flex'>
     <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk"] font-semibold p-20'>
          <div className="heading">
          <h1 className='text-8xl tracking-tighter -mb-6'>EYE- </h1>
          <h1 className='text-8xl tracking-tighter -mb-6'>OPENING</h1>
          </div>
     ...
     <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk"] font-semibold p-20'>
          ...
          <div className="heading">
          <h1 className='text-7xl tracking-tighter uppercase pr-40'>presentations</h1>
          </div>
          <div className="dets flex flex-col pl-40 font-['Neue_Montreal'] text-2xl font-light">
               <a className='mb-3' href="#">Facebook</a>
               <a className='mb-3' href="#">Instagram</a>
               <a className='mb-3' href="#">Twitter</a>
          </div>
          <h1 className='pl-40'>&copy;ochi.design2024</h1>
     </div>
    </div>
  )
}
